...
<a href={post.url} class="flex flex-col w-full h-full p-4 bg-white rounded-md">
    <div class="flex mb-4 align-center">
        <img alt={post.domain} class="w-10 h-10 mr-2" src="https://www.google.com/s2/favicons?sz=256&domain_url={post.domain}"/>
